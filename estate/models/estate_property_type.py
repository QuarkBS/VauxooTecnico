...
class EstatePropertyType(models.Model):
    ...
    offer_ids = fields.One2many("estate.property.offer", "property_type_id",string="Offers", compute="_compute_offer")    
    offer_count = fields.Integer(compute="_compute_offer")
    _sql_constraints = [("check_name", "UNIQUE(name)", "Type name cannot be repeated!")]
